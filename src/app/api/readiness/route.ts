...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    bitgetMcpServerUrl: 'https://agent.bitget.com/mcp',
    mcpStatus: 'Bitget MCP verification pending/unavailable — no MCP market data used.',
    mcpVerified: false,
    supportedRTokens: ['rNVDA', 'rAAPL', 'rMSFT', 'rTSLA', 'rSPY', 'rQQQ'],
